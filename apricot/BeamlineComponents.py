...
class Beam():
    Type="Beam"
    def __init__( self, ParticleTpye=None, NumberOfParticles=None, ParticleMass=None, BeamEnergy=None, BeamMatrix=None, TwissParameters=None, BeamPositions=None ):
...
class DipoleMagnet( BeamLineComponents ):
    Type="DipoleMagnet"
    def __init__( self, Name=None, Length=None, Angle=None, Strength=None, ybend=0 ):
        self.Angle = Angle
        self.Strength = Strength
        rho = math.sqrt(Strength)
