...
NumberOfParticles = 1000   # number of particle
...
beamline = bl.Beamline( "beamline", [drift] )
fn.TransportBeam( Beam, beamline.Elements, 0.1 )
out.getBeam( Beam, path="outputs", tag="drift" )

# Creating a Quadrupole Magnet with a length of 0.2 m and a power of 0.5
quad = blc.QuadrupoleMagnet("quadrupole",0.5,0.4)
beamline = bl.Beamline( "beamline", [quad] )
fn.TransportBeam( Beam, beamline.Elements, 0.1 )
out.getBeam( Beam, path="outputs", tag="quad" )
